    ...
    <footer className="w-full bg-white dark:bg-background">
      ...
      <div className="py-12 px-6 lg:px-20">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
          ...
          <div className="flex flex-col gap-4">
            <h3 className="text-base font-medium text-text-dark dark:text-foreground capitalize" style={{ fontFamily: 'Outfit, sans-serif' }}>
              Reach Us
            </h3>
            <div className="flex flex-col gap-2">
              <div className="flex flex-col sm:flex-row gap-4">
                <span className="text-sm font-normal text-text-gray dark:text-muted-foreground" style={{ fontFamily: 'Outfit, sans-serif' }}>
                  Tel: 0723 770365
                </span>
              </div>
              <span className="text-sm font-normal text-text-gray dark:text-muted-foreground" style={{ fontFamily: 'Outfit, sans-serif' }}>
      ...
      <div className="border-t border-border dark:border-border py-6 px-6 lg:px-20">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-base text-text-gray dark:text-muted-foreground" style={{ fontFamily: 'Inter, sans-serif' }}>
          ...
          <div className="flex items-center gap-6">
            <a 
              href="#" 
              className="text-base font-normal text-text-link dark:text-primary hover:opacity-80 transition-opacity underline"
